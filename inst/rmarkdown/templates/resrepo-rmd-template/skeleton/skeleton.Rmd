...
* `res_dir`: output folder where any outputs or results should be saved, e.g. 
...
res_dir <- path_resrepo("/data/intermediate/plots")
res_dir # print out
...
filename
renv_filename <- paste0(res_dir, "/renv_", filename, ".json") # define name file renv
