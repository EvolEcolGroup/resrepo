...
In a RMarkdown doocument within a `resrepo` repository, it easy to find data
...
We will however create some results. So, first we create the apprpriate directory:
```{r make_res_dir}
dir.create(path_resrepo('/results/plots'), 
           showWarnings = FALSE)
res_dir <- path_resrepo('/results/plots')
```
...
# and save it
pdf(file.path(res_dir, "fig_flip_vs_mass.pdf"))
print(penguins_plot)
dev.off()
