#' Delete data source
#'
#' This function deletes a data source to the data_source_list.csv file. If still
#' present, the directory is removed, but only if it is empty.
#'
...
data_source_delete<- function(dir=NULL, git_path=NULL){
  ...
  utils::write.csv(original_sources, 
                   path_resrepo("./data/data_source_list.csv"),row.names = FALSE)
