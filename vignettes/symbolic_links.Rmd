...
```{r echo=FALSE}
fs::dir_tree(path=base_dir, recurse = 3)
```
...
dir.create(file.path(onedrive_dir,"project1/data/raw/data_input"))
```
```{r echo=FALSE}
...
he git repository. In reality, this is a link to the directory with the same
